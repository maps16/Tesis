...
\medskip
\tiny{Hermosillo, Sonora a Octubre, 2023 }
}
...
%========================================================================================
	...
	\begin{frame}
			\only<1>{\small Vemos que la masa media de los halos crece junto con el valor de $\Omega_0$. De manera que la cosmología con mayor $\Omega_0$ tiene la mayor masa media. }
			\only<2>{\small Mientras que la desviación estándar, en $z$ altos, las cosmología  sub-crítica es mayor que el resto y en $z$ pequeños la desviación tiende a $10^{0.5} M_\odot$}
		\begin{columns}[t]
			\begin{column}{.5\textwidth}
				\begin{figure}
					\centering
...
%========================================================================================
	\begin{frame}
		\only<1> {\small Vemos que el radio medio de las diferentes cosmologías tiene un crecimiento similar y son difíciles de distinguir.}
		\only<2>{\small Mientras la desviación estándar del radio, muestra que las cosmologías sub-críticas tienen mayor variación que el resto para $z$ intermedios, pero en $z$ pequeños tienden a $10^{0.19}$ kpc.}
...
%========================================================================================
	...
	\begin{frame}
		...
		\only<2> {\small En cuanto a su desviación estándar, vemos el mismo comportamiento, si incrementar $\Omega_0$ la desviación aumenta y el Universo sub-crítico tiene la desviación menor.}
...
\begin{frame}
	...
	\begin{figure}[H]
	    ...
	    \includegraphics[width = 0.25\linewidth]{RunCanonica/RunCanonicaZ0.png}   %Canon
