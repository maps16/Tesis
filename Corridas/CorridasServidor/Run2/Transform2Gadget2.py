...
def change(data): #data es el string del nombre del archivo (direccion del archivo)
    ...
    subp.call( [ 'mv', ndat, '/home/martin/Documentos/Tesis/Corridas/CorridasServidor/Run2/gadget2/.' ]  ) #MOVERLO A LA CARPETA DESEADA

#Cargar lista de nombre de archivos
arch = gl.glob('/home/martin/Documentos/Tesis/Corridas/CorridasServidor/Run2/gadget4/snapshot*', recursive = False)
