...
arch = '/home/martin/Documentos/Tesis/Corridas/CorridasServidor/Run1/snp17/halos_0.0.ascii'
...
fof = h5py.File('/home/martin/Documentos/Tesis/Corridas/CorridasServidor/Run1/snp17/fof_tab_017.hdf5', 'r')
...
#ROCKSTAR
log10Mass= np.log10( datos[:,2] ) #MASA EN LOGARITMO10
fig, ax = plt.subplots()
ax.hist(log10Mass, bins = 6, range = ( 8.5, 14.5) )
plt.ylabel('N Bin')
...
ax.hist(log10Massfof10, bins = 6, range = ( 8.5, 14.5), color="black" )
