...
% En la figura \ref{fig:Canon-MassDistSep} y \ref{fig:Canon-MassDist} podemos observar que aunque disminuyen la cantidad de halos después del $z=2$, podemos ver que comienzan a aparecer estructuras mas masivas. La mayor parte de los halos tiene una masa entre $10^{10.3}M\_odot$ y $10^{11}M_\odot$ teniendo el halo de mayor masa de $10^{14.3}m_\odot$. Podemos apreciar como con el tiempo, los halos de materia oscura se vuelven mas masivos y aumenta su cantidad así como vemos un aumento en la variedad de masas que hay. Por lo que en redshifts altos vemos pocas y pequeñas estructuras y en redshifts bajos vemos una mayor cantidad de estructuras con una gran variedad en las masas.
...
\begin{figure}[H]
    ...
    \caption[Distribución de la velocidad circular máxima de un Universo $\Omega_\lambda = 0.691 $, $\Omega_0 = 0.309$]{\footnotesize Mostramos la cantidad de halos de materia oscura en los diferentes rangos de circular máxima en un Universo $\Omega_\lambda = 0.691 $, $\Omega_0 = 0.309$.}
